...
const TermsOfUse = () => {
    return (
        <View style={[styles.container, general.container]}>
            ...
            <ScrollView>
                <Text style={styles.textTitle}>1. Terms</Text>
                ...
                <Text style={styles.textTitle}>2. Use License</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>3. Disclaimer</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>4. Limitations</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>5. Accuracy of materials</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>6. Links</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>7. Modifications</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textTitle}>8. Governing Law</Text>
                <Text style={styles.text}>
